namespace Integration.Tests
{
    ...
    public class ControllerTests
    {
        ...
        public void AddChildShouldAssignAChildcategoryToTheParent()
        {
            ...
            // Assert
            Assert.AreEqual(parentCategory.Children.Count, 1, "AddChild doesn't assign a child category to it's parent");
        }
        ...
        public void RemoveCategoryShoildRemoveItEvenWhenIsAChildToAnotherOne()
        {
            ...
            // Assert
            Assert.AreEqual(0, this.categories.First().Children.Count, "Child category is not removed");
        }
        ...
        public void RemoveCategoryShouldMoveChildCategoriesToItsParentOne()
        {
            ...
            this.categoryController.AddChild(biggestParent.Children.First(), thirdCategoryName);

            // Act
            this.categoryController.RemoveCategory(secondCategoryName);

            // Assert
            Assert.AreEqual(this.categories.First().Children.Count, 1, "Removing a category looses all of its subb-categories");
            Assert.AreEqual(
                thirdCategoryName,
                this.categories.First().Children.First().Name,
