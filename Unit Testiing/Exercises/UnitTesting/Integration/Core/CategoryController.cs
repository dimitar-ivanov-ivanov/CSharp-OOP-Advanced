namespace Integration.Core
{
    ...
    public class CategoryController : IController
    {
        ...
        {
            if (this.categories.Any(c => c.Name == name || c.Children.Any(cc => cc.Name == name)))
            {
                return;
            }
        ...
        public void RemoveCategory(string name)
        {
            ...
            if (categoryToRemove == null)
            {
                ...
                {
                    if ((categoryToRemove = category.Children
        ...
        private void MooveChildrentCategoriesToParent(ICategory categoryToRemove)
        {
            if (categoryToRemove.Parent == null)
            {
                foreach (var category in categoryToRemove.Children)
                {
